...
<template>
  <div class="flex justify-between text-14px">
    <NuxtLink :class="{ 'opacity-30': pre === null }" :to="pre ? pre._path : ''" hover="bg-my-20" class="w-40% border border-#e5e5e5 rounded-2 px-3 py-2 dark:border-#555">
      <div class="flex">
    ...
    <NuxtLink :class="{ 'opacity-30': next === null }" class="w-40% border border-#e5e5e5 rounded-2 px-3 py-2 dark:border-#555" hover="bg-my-20" :to="next ? next._path : ''">
